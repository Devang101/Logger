...
var LogAddForm = React.createClass({
  getInitialState: function() {
  ...
  handleSubmit: function(e) {
    ...
    this.props.onLogAddSubmit({Timestamp: Timestamp, EventType: EventType, EventSeverity: EventSeverity, Message:Message});
    this.setState({Timestamp: '', EventType: '', EventSeverity: '', Message: ''});
  },
  render: function() {
    return (
      <form className='LogFrom' onSubmit={this.handleSubmit}>
        <input type='text' placeholder="Timestamp" value ={this.state.Timestamp} onChange={this.handleTimestampChange}/>
...
var LogBox = React.createClass({
  ...
  handleLogAddSubmit: function(Log) {
  ...
  render: function() {
    return (
      <div className="LogBox">
        ...
        <LogAddForm onLogAddSubmit={this.handleLogAddSubmit} />
